...
void DL_PDU::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->dpduid);
    doParsimUnpacking(b,this->type);
    doParsimUnpacking(b,this->source);
    doParsimUnpacking(b,this->destination);
}

int DL_PDU::getDpduid() const
{
    return this->dpduid;
}

void DL_PDU::setDpduid(int dpduid)
{
    this->dpduid = dpduid;
}
...
int DL_PDU::getSource() const
{
    return this->source;
}

void DL_PDU::setSource(int source)
{
    this->source = source;
}

int DL_PDU::getDestination() const
{
    return this->destination;
}

void DL_PDU::setDestination(int destination)
{
...
int DL_PDUDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "dpduid")==0) return base+0;
...
std::string DL_PDUDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    DL_PDU *pp = (DL_PDU *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getDpduid());
...
bool DL_PDUDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    DL_PDU *pp = (DL_PDU *)object; (void)pp;
    switch (field) {
        case 0: pp->setDpduid(string2long(value)); return true;
